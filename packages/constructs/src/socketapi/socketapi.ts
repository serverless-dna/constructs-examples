...
import { DnaConstruct } from '../core/construct';
...
export interface SocketFunction {
...
export interface SocketApiConfig {
  readonly stage?: string;
  readonly removalPolicy?: RemovalPolicy;
  readonly routes?: SocketFunction[];
...
export class SocketApi extends DnaConstruct {
  ...
  constructor(scope: Construct, id: string, config?: SocketApiConfig) {
    super(scope, id);
  ...
  protected createWebSocketApi(config: SocketApiConfig): WebSocketApi {
   ...
   */
  protected addRoutes(routes: SocketFunction[]) {
